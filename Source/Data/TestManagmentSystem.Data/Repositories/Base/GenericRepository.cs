namespace TestManagmentSystem.Data.Repositories.Base
{
    ...
    using TestManagmentSystem.Common.Extensions;

    public class GenericRepository<T> : IRepository<T> where T : class
    {
        public GenericRepository(ITestManagmentSystemDbContext context)
        {
            if (context == null)
            {
        ...
        protected ITestManagmentSystemDbContext Context { get; set; }
